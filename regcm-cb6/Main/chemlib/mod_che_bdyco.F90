...
module mod_che_bdyco
  ...
  integer(ik4) , parameter :: max_incb6_tracers = 55
...
!
  subroutine allocate_mod_che_bdyco
    ...
    if ( chemsimtype(1:4) ==  'CB6C') then
      call getmem1d(ichbdy2trac,1,max_incb6_tracers,'che_bdyco:ichbdytrac')
      call getmem4d(chebdy,jce1,jce2,ice1,ice2,1,kz, &
                    1,max_incb6_tracers,'che_bdyco:chebdy')
    else
  ...
  subroutine che_init_bdy
    ...
    if ( ichebdy == 1 ) then
      ...
      if ( idynamic == 2 ) then
        ...
        if ( chemsimtype(1:4) ==  'CB6C') then
          call nhinterp(ice1,ice2,jce1,jce2,kz,max_incb6_tracers, &
