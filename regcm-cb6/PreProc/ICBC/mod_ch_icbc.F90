...
!  integer(ik4) , pointer , dimension(:) :: xtimes
  ...
  public :: header_ch_icbc , get_ch_icbc , get_c6_icbc , close_ch_icbc
...
!   chv4(:,:,:,cb6_OZN)   = (0.6D0*chv4_1(:,:,:,mz_O3))*w_ozn/amd
    chv4(:,:,:,cb6_OZN)   = chv4_1(:,:,:,mz_O3)*w_ozn/amd
    chv4(:,:,:,cb6_NMOX)  = chv4_1(:,:,:,mz_NO)*w_nmox/amd
!   chv4(:,:,:,cb6_NDOX)  = (0.8D0*chv4_1(:,:,:,mz_NO2))*w_ndox/amd
    chv4(:,:,:,cb6_NDOX)  = chv4_1(:,:,:,mz_NO2)*w_ndox/amd
    chv4(:,:,:,cb6_NTRC)  = chv4_1(:,:,:,mz_HNO3)*w_ntrc/amd
    chv4(:,:,:,cb6_PNA)   = chv4_1(:,:,:,mz_HO2NO2)*w_pna/amd
    chv4(:,:,:,cb6_DNPO)  = chv4_1(:,:,:,mz_N2O5)*w_dnpo/amd
    chv4(:,:,:,cb6_HPOX)  = chv4_1(:,:,:,mz_H2O2)*w_hpox/amd
    chv4(:,:,:,cb6_MTHA)  = chv4_1(:,:,:,mz_CH4)*w_mtha/amd
    chv4(:,:,:,cb6_CMON)  = chv4_1(:,:,:,mz_CO)*w_cmon/amd
    chv4(:,:,:,cb6_SDIO)  = chv4_1(:,:,:,mz_SO2)*w_sdio/amd
    chv4(:,:,:,cb6_SULF)  = chv4_1(:,:,:,mz_SO4)*w_sulf/amd
    chv4(:,:,:,cb6_PRPA)  = (3.0D0*chv4_1(:,:,:,mz_C3H8))*w_prpa/amd !double
!   chv4(:,:,:,cb6_PRPA) = (3*chv4_1(:,:,:,mz_C3H8)+4*chv4_1(:,:,:,mz_BIGALK)+chv4_1(:,:,:,mz_C3H6)+chv4_1(:,:,:,mz_BIGENE))*w_alka/amd

!   chv4(:,:,:,cb6_ALKA) = (3*chv4_1(:,:,:,mz_C3H8)+4*chv4_1(:,:,:,mz_BIGALK)+chv4_1(:,:,:,mz_C3H6)+chv4_1(:,:,:,mz_BIGENE))*w_alka/amd
  ! CBMZ PAR original
!   chv4(:,:,:,cb6_ALKA)  = chv4_1(:,:,:,mz_BIGALK)*w_alka/amd ! CBMZ PAR mod
    chv4(:,:,:,cb6_ETHA)  = chv4_1(:,:,:,mz_C2H6)*w_etha/amd
    chv4(:,:,:,cb6_ETHE)  = chv4_1(:,:,:,mz_C2H4)*w_ethe/amd
    chv4(:,:,:,cb6_IOLE)  = chv4_1(:,:,:,mz_BIGENE)*w_iole/amd ! CBMZ OLET original
!   chv4(:,:,:,cb6_OLE)   = chv4_1(:,:,:,mz_C3H6)*w_ole/amd ! CBMZ OLET mod
    chv4(:,:,:,cb6_OLE)   = chv4_1(:,:,:,mz_BIGENE)*w_ole/amd
    chv4(:,:,:,cb6_TOLN)  = chv4_1(:,:,:,mz_TOLUENE)*w_toln/amd
    chv4(:,:,:,cb6_XYLN)  = chv4_1(:,:,:,mz_TOLUENE)*w_xyln/amd
!   chv4(:,:,:,cb6_ISPR)  = chv4_1(:,:,:,mz_ISOP)*w_ispr/amd
    chv4(:,:,:,cb6_CRSL)  = chv4_1(:,:,:,mz_CRESOL)*w_crsl/amd
    chv4(:,:,:,cb6_ROPN)  = chv4_1(:,:,:,mz_BIGALD)*w_ropn/amd
!   chv4(:,:,:,cb6_NTR2)  = chv4_1(:,:,:,mz_ISOPNO3)*w_ntr2/amd ! CBMZ likely ISOPN
    chv4(:,:,:,cb6_NTR2)  = (chv4_1(:,:,:,mz_ONIT)+chv4_1(:,:,:,mz_ONITR))*w_cron/amd
    chv4(:,:,:,cb6_ISPD)  = (4.0D0*(chv4_1(:,:,:,mz_MVK)+chv4_1(:,:,:,mz_MACR)+chv4_1(:,:,:,mz_HYDRALD)))*w_ispd/amd ! CBMZ likely ISOPRD
!   chv4(:,:,:,cb6_CRON)  = (chv4_1(:,:,:,mz_ONIT)+chv4_1(:,:,:,mz_ONITR))*w_cron/amd ! CBMZ ONIT
    chv4(:,:,:,cb6_MEGY)  = chv4_1(:,:,:,mz_CH3COCHO)*w_megy/amd
    chv4(:,:,:,cb6_ACET)  = (chv4_1(:,:,:,mz_CH3COCH3)+chv4_1(:,:,:,mz_HYAC)+chv4_1(:,:,:,mz_MEK))*w_acet/amd ! CBMZ AONE original
!   chv4(:,:,:,cb6_ACET)  = chv4_1(:,:,:,mz_CH3COCH3)*w_acet/amd ! CBMZ AONE mod
    chv4(:,:,:,cb6_PACN)  = chv4_1(:,:,:,mz_PAN)*w_pacn/amd
!   chv4(:,:,:,cb6_AACD)  = chv4_1(:,:,:,mz_CH3COOH)*w_aacd/amd
    chv4(:,:,:,cb6_AALD)  = (chv4_1(:,:,:,mz_CH3CHO)+chv4_1(:,:,:,mz_GLYALD))*w_aald/amd ! CBMZ ALD2 original
!   chv4(:,:,:,cb6_AALD)  = chv4_1(:,:,:,mz_CH3CHO)*w_aald/amd ! CBMZ ALD2 mod
    chv4(:,:,:,cb6_FORM)  = chv4_1(:,:,:,mz_CH2O)*w_form/amd
    chv4(:,:,:,cb6_MEOH)  = chv4_1(:,:,:,mz_CH3OH)*w_meoh/amd

    chv4(:,:,:,cb6_GLYD)  = (4.0D0*chv4_1(:,:,:,mz_GLYALD))*w_glyd/amd
    chv4(:,:,:,cb6_MEPX)  = chv4_1(:,:,:,mz_CH3OOH)*w_mepx/amd
!!   chv4(:,:,:,cb6_NTR2)  = chv4_1(:,:,:,mz_ONIT)*w_ntr2/amd
!!   chv4(:,:,:,cb6_INTR)  = chv4_1(:,:,:,mz_ONIT)*w_intr/amd
    chv4(:,:,:,cb6_INTR)  = chv4_1(:,:,:,mz_ISOPNO3)*w_ntr2/amd 
!    chv4(:,:,:,cb6_KET)   = chv4_1(:,:,:,mz_MEK)*w_ket/amd
!    chv4(:,:,:,cb6_ISPD)  = chv4_1(:,:,:,mz_MACR)*w_ispd/amd !double?
!!   chv4(:,:,:,cb6_HPLD)  = chv4_1(:,:,:,mz_XOOH)*w_hpld/amd
!    chv4(:,:,:,cb6_XOPN)  = chv4_1(:,:,:,mz_BIGALD)*w_xopn/amd
!    chv4(:,:,:,cb6_NTR1)  = chv4_1(:,:,:,mz_ONITR)*w_ntr1/amd
!    !chv4(:,:,:,cb6_O)     = chv4_1(:,:,:,mz_O)*w_o/amd
!    !chv4(:,:,:,cb6_OSNG)  = chv4_1(:,:,:,mz_O1D)*w_osng/amd
!!   chv4(:,:,:,cb6_NTOX)  = chv4_1(:,:,:,mz_NO3)*w_ntox/amd
!!   chv4(:,:,:,cb6_HOX)   = chv4_1(:,:,:,mz_OH)*w_hox/amd
!!   chv4(:,:,:,cb6_POX)   = chv4_1(:,:,:,mz_HO2)*w_pox/amd
!!   chv4(:,:,:,cb6_MEO2)  = chv4_1(:,:,:,mz_CH3O2)*w_meo2/amd
    chv4(:,:,:,cb6_ETOH)  = chv4_1(:,:,:,mz_C2H5OH)*w_etoh/amd
!!   chv4(:,:,:,cb6_ACOO)  = chv4_1(:,:,:,mz_CH3CO3)*w_acoo/amd
!!   chv4(:,:,:,cb6_ROO)   = chv4_1(:,:,:,mz_ENEO2)*w_roo/amd
!!   chv4(:,:,:,cb6_ISO2)  = chv4_1(:,:,:,mz_ISOPO2)*w_iso2/amd
!!   chv4(:,:,:,cb6_ISPX)  = chv4_1(:,:,:,mz_ISOPOOH)*w_ispx/amd
    chv4(:,:,:,cb6_TERP)  = chv4_1(:,:,:,mz_C10H16)*w_terp/amd
!!   chv4(:,:,:,cb6_TOLR)  = chv4_1(:,:,:,mz_TOLO2)*w_tolr/amd
!!   chv4(:,:,:,cb6_XYLR)  = chv4_1(:,:,:,mz_TOLO2)*w_xylr/amd
!!   chv4(:,:,:,cb6_GLY)   = chv4_1(:,:,:,mz_GLYOXAL)*w_gly/amd
    chv4(:,:,:,cb6_BENZ)  = (0.29D0*chv4_1(:,:,:,mz_TOLUENE))*w_benz/amd


    call write_c6_icbc(idate)
  end subroutine get_c6_icbc
