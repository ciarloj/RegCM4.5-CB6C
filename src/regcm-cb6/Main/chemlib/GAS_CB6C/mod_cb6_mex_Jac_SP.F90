...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 USE mod_cb6_Model
      ...
      REAL(kind=dp) V(76), F(5), RCT(218)
      REAL(kind=dp) JVS(1077)
...
! Check for the right number of output arguments
     ...
     &JVS(1077)')
      ...
      plhs(1) = mxCreateDoubleMatrix(1077,1,0)
      ...
      RPtr = mxGetPr(prhs(3))
      CALL mxCopyPtrToReal8(RPtr,RCT,218)

      JVSPtr = mxGetPr(plhs(1))

      CALL Jac_SP( V, F, RCT, JVS )

      CALL mxCopyReal8ToPtr(JVS, JVSPtr, 1077)
