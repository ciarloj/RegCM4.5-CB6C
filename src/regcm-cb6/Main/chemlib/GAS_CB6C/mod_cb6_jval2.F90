...
!
      ...
      integer(ik4) :: i , ialt , ig01 , ig02 , ig11 , ig12 , ig21 , &
                 ig22 , ij , izen , j , jaer , jalb ,  jc ,  &
                 jcld , jct , jtem , k , kn !, iwri
...
!
      ...
      integer(ik4) :: i , ig , iz , j , jaer , jalb , jc , jcld ,     &
                 jct , jtem , k , m , n , nmax !, iwri
      real(rk8) :: x , y
!
